...
// These assert the truecolor encoding, so they pin the profile explicitly
// rather than depending on the test host's $COLORTERM (which would make them
// pass or fail by luck of the environment).
